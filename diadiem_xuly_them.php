...
<body>
    ...
    <script type="module">
        import { getFirestore, collection, addDoc, doc, GeoPoint } from 'https://www.gstatic.com/firebasejs/11.5.0/firebase-firestore.js';
        ...
        try {
            ...
            const docRef = await addDoc(collection(db, "diadiem"), {
